...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 15 17:08:13 2018
...
#        Fmt = np.dot(self.Fmgx,self.tangent)
        ...
        k30 *= self.getFactor()*r*2.0*np.pi/self.material.mu0
        K[3,0] -= k30[0]
        K[3,1] -= k30[1]
        k32 = 0.5*self.N_[inod]*self.N_[jnod]*self.Fmg[1,1]*self.getFactor()
        k32 *= r*2.0*np.pi/self.material.mu0
        K[3,2] -= k32
...
#            raise Exception;
        ...
        factor = self.getFactor()*2.0*np.pi*self.x_[0]/self.material.mu0
...
#            raise Exception
        ...
        ri *= self.N_[inod]*wfac/self.material.mu0
...
output = FO.StandardFileOutput('/home/haiau/Documents/result_BI_1000A.dat')
